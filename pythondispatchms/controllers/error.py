...
class ErrorController(BaseController):
    ...
    @expose('pythondispatchms.templates.error')
    ...
    @expose('pythondispatchms.templates.error.restError')
    def restError(test, **kw):
        return dict(error=kw['error'],descript=kw['descript'])
