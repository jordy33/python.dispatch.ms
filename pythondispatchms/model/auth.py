...
It's perfectly fine to re-use this definition in the python.dispatch.ms application,
though.
...
from pythondispatchms.model import DeclarativeBase, metadata, DBSession
...
class User(DeclarativeBase):
    ...
    created = Column(DateTime, default=datetime.now)
    end_event = Column(Boolean, default=False)
