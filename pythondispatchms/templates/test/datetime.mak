...
<script src="${tg.url('/lib/js/bootstrap.min.js')}"></script>
    ...
    <link href="${tg.url('/lib/test/jquery.timepicker.css')}" rel="stylesheet">
    <script src="${tg.url('/lib/test/jquery.timepicker.js')}"></script>

    <link href="${tg.url('/lib/test/bootstrap-datepicker.css')}" rel="stylesheet">
    <script src="${tg.url('/lib/test/bootstrap-datepicker.js')}"></script>

    <link href="${tg.url('/lib/test/site.css')}" rel="stylesheet">
    <script src="${tg.url('/lib/test/site.js')}"></script>

    <script src="${tg.url('/lib/test/datepair.js')}"></script>
    <script src="${tg.url('/lib/test/jquery.datepair.js')}"></script>
