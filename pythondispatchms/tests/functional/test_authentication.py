...
As python.dispatch.ms grows and the authentication method changes, only these tests
should be updated.
...
from pythondispatchms.tests import TestController
...
class TestAuthentication(TestController):
    ...
    def test_logout(self):
        ...
        resp = self.app.get('/login_handler?login=dispatch&password=managepass',
                            status=302)
